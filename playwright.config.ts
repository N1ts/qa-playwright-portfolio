...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "chromium",
      testMatch: /ui\/(?!login\.spec\.ts$).*\.spec\.ts/,
      use: {
    ...
    {
      name: "api",
      testMatch: /api\/(auth|users|projects)\.spec\.ts/,
      use: {
        baseURL: "http://localhost:3000",
    ...
    {
      name: "api-viewer-setup",
      testMatch: /api\/viewer-auth\.setup\.ts/,
      use: {
        baseURL: "http://localhost:3000",
      },
    },
